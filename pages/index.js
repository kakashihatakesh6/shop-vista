...
export default function Home() {
  ...
  return (
    <>
      ...
      {IsLoading && <div role="status" className='absolute mt-60 left-1/2 -translate-x-1/2 md:left-[50rem] md:translate-x-0'>
        ...
        <div className="container px-5 py-4 mx-auto bg-white">
          ...
          <div className="flex flex-wrap -m-4 shadow-sm bg-slate-100">
            ...
            {ElectronicsData && ElectronicsData.slice(0, 6).map((item, index) => (
              ...
              <div key={index} className="w-1/2 md:w-1/4 lg:w-1/6 py-4 px-1">
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-12 mx-auto shadow-sm bg-slate-100">
          ...
          <div className="flex flex-wrap w-full mb-6 flex-col items-center text-center">
            <img src={randow[0]} alt="" className="w-full h-auto object-contain" />
          </div>
          <div className="flex flex-wrap -m-4">

            <div className="xl:w-1/3 md:w-1/2 w-full h-auto md:h-[220px] px-1 mb-2">
              <img src={randow[2]} alt="img-2" className="w-full md:w-auto h-auto md:h-[220px] object-cover md:object-fill" />
            </div>
            <div className="xl:w-1/3 md:w-1/2 w-full h-auto md:h-[220px] px-1 mb-2">
              <img src={randow[3]} alt="img-2" className="w-full md:w-auto h-auto md:h-[220px] object-cover md:object-fill" />
            </div>
            <div className="xl:w-1/3 md:w-1/2 w-full h-auto md:h-[220px] px-1 mb-2">
              <img src={randow[1]} alt="img-2" className="w-full md:w-auto h-auto md:h-[220px] object-cover md:object-fill" />
            </div>
            <div className="xl:w-1/3 md:w-1/2 w-full h-auto md:h-[220px] px-1 mb-2">
              <img src={randow[1]} alt="img-2" className="w-full md:w-auto h-auto md:h-[220px] object-cover md:object-fill" />
            </div>
